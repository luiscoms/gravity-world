    ...
    /** @scope me.AnimationSheet.prototype */
    {
        ...
        buildLocalAtlas : function (atlas, indices, image) {
            ...
            if (typeof(atlas) !== "undefined") {
                ...
                // console.log(image.width, image.height, this.margin, this.spacing);
                // console.log(this.width, this.height, this.margin, this.spacing);
                // console.log(image.width - this.margin) % (this.width + this.spacing);
                // console.log(image.height - this.margin) % (this.height + this.spacing);
