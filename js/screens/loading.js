game.LoadingScreen = me.ScreenObject.extend({
    init : function () {
        ...
        //var
        this.ProgressBar = me.Renderable.extend({
        ...
        this.TextLogo = me.Renderable.extend({
            // constructor
            init : function (w, h) {
        ...
        this.IconLogo = me.Renderable.extend({
            // constructor
            init : function (x, y) {
                this._super(me.Renderable, 'init', [x, y, 114, 114]);
            },
    ...
    onResetEvent : function () {
        ...
        var icon = new this.IconLogo(
            (me.video.renderer.getWidth() - 120) / 2,
            (me.video.renderer.getHeight() / 2) - (progressBar.barHeight / 2) - 120
        );
